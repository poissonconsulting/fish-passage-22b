description <- c(
  "`eAlpha`" = "Parameter representing the maximum stream temperature",
  "`bAlphaIntercept`" = "Intercept for `eAlpha`",
  "`bLogisticPars[, 1]`" = "Effect of `site` on `bAlphaIntercept`",
  "`eGamma`" = "Parameter representing a measure of the steepest slope of the function",
  "`bGammaIntercept`" = "Intercept for `eGamma`",
  "`bLogisticPars[, 3]`" = "Effect of `site` on `bGammaIntercept`",
  "`eBeta`" = "Parameter representing the air temperature at the inflection point of the curve",

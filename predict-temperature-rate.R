...
# Correlation as a function of discharge
correlation <- predict(analysis, "discharge", term = "ePhi")

gp <- ggplot(correlation, aes(x = discharge)) +
  geom_line(aes(y = estimate)) +
  geom_line(aes(y = lower), linetype = "dotted") +
  geom_line(aes(y = upper), linetype = "dotted") +
  xlab("Discharge (units tbd)") +
  ylab("Correlation") +
  NULL
